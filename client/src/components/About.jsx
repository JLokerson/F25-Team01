...
function MostOfTheText() {
        ...
        setSponsors([
          {
            id: 1,
            name: "Test Sponsor 1",
            description: "Sample sponsor for testing",
          },
          {
            id: 2,
            name: "Test Sponsor 2",
            description: "Another sample sponsor",
          },
        ]);
      } finally {
        setLoading(false);
  ...
  return (
    <div className="landing">
        ...
        <div className="container-fluid px-4">
          ...
          <div className="collapse navbar-collapse" id="aboutNav">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
              ...
              <li className="nav-item">
                <button
                  className="nav-link btn btn-outline-light rounded-pill ms-2"
                  onClick={GoToLogin}
                >
                  Login
                </button>
      ...
      <div
        className="container mt-4 about-content"
        style={{ position: "relative", zIndex: 10, flex: 1 }}
      >
        <h1
          className="landing__title text-center"
          style={{
            color: "var(--text)",
            textShadow: "2px 2px 4px rgba(0,0,0,0.8)",
          }}
        >
          About Our Driver Rewards Program
        </h1>
        <br />
        ...
        >
          This website is intended to be used for drivers to earn rewards points
          and claim rewards.
        </p>

        {error && (
          <div
            className="alert alert-danger about-section"
            role="alert"
            style={{
      ...
      <footer className="landing__footer">
        &copy; {aboutData.versionDate} {aboutData.groupName} v
        {aboutData.version}{" "}
      </footer>
    </div>
  );
