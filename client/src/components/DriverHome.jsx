...
export default function DriverHome() {
  ...
  const isAdminImpostor =
    impostorMode && localStorage.getItem("impostorType") === "driver";
    ...
    const checkPasswordReminder = () => {
      ...
      if (userString) {
        ...
        if (reminderDate && new Date(reminderDate) > now) {
          console.log(
            "DriverHome - Reminder is set for future, skipping modal"
          );
          return;
        }
        ...
        if (lastLoginDate) {
          ...
          if (lastLoginDate < threeMonthsAgo) {
            console.log(
              "DriverHome - LastLogin is older than 3 months, showing modal"
            );
  ...
  return (
    <div>
      ...
      <div className="container my-5">
        ...
        <p>
          This is where drivers can see their dashboard and relevant
          information.
        </p>
          ...
          <div className="col-md-6 mb-3">
            <div className="card">
              <div className="card-body">
                ...
                <Link to="/drivercart" className="btn btn-primary">
                  Go to Cart
                </Link>
              </div>
            </div>
          ...
          <div className="col-md-6 mb-3">
            <div className="card">
              <div className="card-body">
                ...
                <Link to="/driver-catalog-cart" className="btn btn-primary">
                  Browse Catalog
                </Link>
              </div>
            </div>
